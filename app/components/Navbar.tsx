...
export default function Navbar() {
  ...
  <Link href="/" className="flex items-center gap-2">
    ...
    <span className="text-xl  font-bold text-gray-900 hidden sm:block">
      جمعية سند بالقنيطرة
          ...
          <div className="hidden md:block">
            ...
            <Link href="/contact" className="text-gray-600 hover:text-blue-600 px-3 py-2 text-2xl font-bold">التواصل</Link>
             <Link href="/projects" className="text-gray-600 hover:text-blue-600 px-3 py-2 text-2xl font-bold">البرامج</Link>
      ...
      <Link href="/projects" onClick={() => setIsOpen(false)} className="block px-3 py-4 text-gray-600">البرامج</Link>
